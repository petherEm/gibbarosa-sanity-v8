...
import ActiveProductFilters from "../filters/active-filters";
import ProductFiltersDrawer from "../filters/filters-drawer";
...
export default async function StoreTemplate({
  ...
  const { sortBy, page, collection, type, material, price } =
    await searchParams;
