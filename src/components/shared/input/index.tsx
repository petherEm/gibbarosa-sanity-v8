...
import { EyeIcon, EyeOffIcon, SearchIcon } from "@/components/shared/icons";
  ...
  ({ type, name, label, touched, required, ...props }, ref) => {
    ...
    return (
      <Box className="flex w-full flex-col gap-2">
        ...
        <Box
          className={cn(
            "relative flex h-12 w-full items-center px-4 py-3.5 border border-secondary outline-none file:border-0 file:bg-transparent file:pt-1 file:text-md file:font-medium focus-within:border focus-within:border-action-primary focus-within:ring-0 focus-within:ring-offset-0 [.dark_&:focus-within]:border-action-primary [.dark_&]:border-secondary [.dark_&]:bg-fg-tertiary",
            {
