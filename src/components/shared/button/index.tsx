...
const buttonVariants = cva({
  ...
  variants: {
    variant: {
      filled:
        "bg-primary hover:bg-primary-hover active:bg-primary-pressed text-inverse-primary",
      ghost:
        "bg-transparent hover:bg-hover active:bg-pressed !rounded-xl !p-4 text-action-primary",
      tonal:
        "bg-secondary text-primary text-action-primary hover:bg-secondary-hover active:bg-secondary-pressed [.dark_&]:bg-tertiary [.dark_&]:hover:bg-tertiary-hover [.dark_&]:active:bg-tertiary-pressed",
