...
import { ChevronDownIcon, TickThinIcon } from "@/components/shared/icons";
  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <SelectPrimitive.Trigger
        ...
        className={cn(
          "border-primary flex w-full items-center justify-between gap-2 border px-4 py-3 text-md text-basic-primary focus-within:ring-0 focus-within:ring-offset-0 focus:outline-none focus-visible:ring-0 focus-visible:ring-offset-0",
