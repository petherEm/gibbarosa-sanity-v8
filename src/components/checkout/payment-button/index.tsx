...
const StripePaymentButton = ({
  ...
  const handlePayment = async () => {
    ...
    try {
      // Destructure both error and paymentIntent from the response
      ...
      if (error) {
        // Optionally, check if error.payment_intent exists and meets a certain status
        setErrorMessage(error.message || null);
        console.error(error);
      } else if (paymentIntent) {
        // Payment succeeded without errors; proceed with order placement
