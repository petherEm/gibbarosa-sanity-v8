...
export async function signup(_currentState: unknown, formData: FormData) {
  ...
  try {
    ...
    console.log("About to revalidate customer tag after signup");
    revalidateTag('customer')
    console.log("Customer tag revalidated after signup");
    // Add explicit return value to prevent automatic redirect
...
export async function login(_currentState: unknown, formData: FormData) {
  ...
  try {
    ...
    // Use this instead of just revalidateTag to prevent automatic redirects
    revalidateTag('customer')
    
    // Return a success value to prevent default redirect
    return { success: true };
  } catch (error: any) {
